defmodule Wifibroadcast.Radio.Inventory do
  @moduledoc """
  ...
  before handing their names to `Wifibroadcast.Radio.Control`.

  Example:

      inventory = Wifibroadcast.Radio.Inventory.discover!()

      target =
        Wifibroadcast.Radio.Inventory.select!(inventory, driver: :rtl8812au)

      Wifibroadcast.Radio.Control.set_monitor_mode(target.interfaces)
      Wifibroadcast.Radio.Control.set_channel(target.interfaces, 149, 20)
  """

  alias Wifibroadcast.Radio.Interface
  alias Wifibroadcast.Radio.Inventory.Selection
