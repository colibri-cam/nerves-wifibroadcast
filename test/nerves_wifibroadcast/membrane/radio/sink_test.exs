defmodule NervesWifibroadcast.TestSupport.FakeTxAFPacket do
...
defmodule NervesWifibroadcast.Membrane.Radio.SinkTest do
    ...
    opts =
      Keyword.merge(
        [
          ...
          socket_backend: NervesWifibroadcast.TestSupport.FakeTxAFPacket
        ],
        opts
      )
