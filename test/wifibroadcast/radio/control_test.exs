defmodule Wifibroadcast.TestSupport.FakeNetlinkSocket do
...
defmodule Wifibroadcast.Radio.ControlTest do
  ...
  test "set_tx_power resolves nl80211 family and applies tx power" do
    ...
    assert :ok =
             Control.set_tx_power("wlan0", {:dbm, 30},
               driver: :rtl8812eu,
               socket_module: Wifibroadcast.TestSupport.FakeNetlinkSocket,
